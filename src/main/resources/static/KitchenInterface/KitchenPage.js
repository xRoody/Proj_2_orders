...
function connect(){
    ...
    client.connect({}, (x)=>{
        client.subscribe('/topic/new', (data)=>{
            showMe(JSON.parse(data.body));
        })
    })
}
